<x-base>
    <div class="container">
        ...
        <a href="{{ route('schedules.index') }}" class="btn btn-primary mb-3" style="width: 150px;">Back to Schedules</a>
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; justify-content: space-between; gap: 20px;">
                            <a href="{{ route('schedules.edit', $schedule->id) }}" class="btn btn-success btn-sm" style="width: 150px">Edit</a>
